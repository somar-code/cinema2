...
onMounted(async () => {
    const res = await axios({
        url: "https://m.maizuo.com/gateway?cityId=110100&pageNum=1&pageSize=10&type=1&k=1692193",
        // https://m.maizuo.com/gateway?cityId=110100&pageNum=1&pageSize=10&type=1&k=1692193
        headers: {
            'X-Client-Info': '{"a":"3000","ch":"1002","v":"5.2.1","e":"172880701114162409845424129","bc":"110100"}',
...
const onLoad = async ()=>{
    ...
    pageNum.value++
    const res = await axios({
        url: `https://m.maizuo.com/gateway?cityId=110100&pageNum=${pageNum.value}&pageSize=10&type=1&k=1692193`,
        // https://m.maizuo.com/gateway?cityId=110100&pageNum=1&pageSize=10&type=1&k=814605
        headers: {
            'X-Client-Info': '{"a":"3000","ch":"1002","v":"5.2.1","e":"172880701114162409845424129","bc":"110100"}',
            'X-Host': 'mall.film-ticket.film.list'
        }
